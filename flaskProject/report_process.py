...
from common_api import ques2data, get_completion
...
def gen_report(template):
    ...
    EXAMPLE: ‘一共有4个订单。其中, 创建时间最早的订单有4个物品，物品总价为200美元。’应转换为’共有几个订单？创建时间最早的订单有几个物品？创建时间最早的订单的物品总价是多少？‘。
    ...
    ATTENTION: 回答仅包含替换后的信息,应当用与template相同的语言给出'''
