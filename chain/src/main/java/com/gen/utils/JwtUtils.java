...
public class JwtUtils {
    ...
    //自己定制密钥
    public static final String SECRET = "GEN";
    //请求头
    ...
    public static String sign(String name, String secret) {
        try {
            ...
            return JWT.create().withClaim("name", name).withExpiresAt(date).sign(algorithm);
    ...
    public static String generateSalt() {
        ...
        return secureRandomNumberGenerator.nextBytes(8).toHex();
    }
}
