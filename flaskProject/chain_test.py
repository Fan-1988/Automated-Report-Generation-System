...
first_prompt = ChatPromptTemplate.from_template(
    ...
    #     "每一个问题应当与句子中第一个对它产生影响的条件相关联。"
    #     "EXAMPLE: ‘来自2个不同的消费者’应转换为‘这些订单来自几个不同的消费者‘或’创建时间在今天之前的订单来自几个不同的消费者‘而不是’物品总价格为200美元的订单\
    # 来自几个不同的消费者‘。"
...
# prompt template 2
_DEFAULT_TEMPLATE = """Given input questions, first create syntactically correct sql queries to run for each question,
